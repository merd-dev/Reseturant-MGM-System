...
const RestaurantService = () => (
  <div className="app__restaurant">
    ...
    {/* Main Content */}
    <div className="app__restaurant-content app__bg section__padding" id="services">
      ...
      <div className="app__restaurant-service flex__center">
        ...
        <div className="app__restaurant-service_info">
          ...
          <p className="p__opensans">Experience intimate gatherings in our exclusive private dining rooms, perfect for special occasions and business meetings.</p>
          <div className="service__features">
            <p><span>Capacity:</span> Up to 20 guests</p>
            <p><span>Menu:</span> Customizable chef's tasting menu</p>
            <p><span>Extras:</span> Dedicated sommelier service</p>
          </div>
      ...
      <div className="app__restaurant-service flex__center reverse__flex">
        <div className="app__restaurant-service_info">
          ...
          <img src={images.spoon} alt="service_spoon" className="spoon__img" />
          <p className="p__opensans">Bring our culinary excellence to your venue with our professional catering services for any event size.</p>
          <div className="service__features">
            <p><span>Services:</span> Full-service catering</p>
            <p><span>Range:</span> 20-500 guests</p>
            <p><span>Options:</span> Buffet or plated service</p>
          </div>
          <button type="button" className="custom__button">Inquire</button>
        </div>
      ...
      <div className="app__restaurant-service flex__center">
        ...
        <div className="app__restaurant-service_info">
          ...
          <img src={images.spoon} alt="service_spoon" className="spoon__img" />
          <p className="p__opensans">An immersive dining experience where you'll witness culinary artistry firsthand at our kitchen counter.</p>
          <div className="service__features">
            <p><span>Experience:</span> 10-course omakase menu</p>
            <p><span>Duration:</span> 2-3 hours</p>
            <p><span>Availability:</span> Thursday-Saturday evenings</p>
          </div>
          <button type="button" className="custom__button">Reserve</button>
        </div>
      </div>
    ...
    <div className="app__restaurant-testimonials app__bg section__padding">
      ...
      <div className="testimonials__grid">
        <div className="testimonial__card">
          <p className="p__opensans">"The private dining experience exceeded all expectations. The attention to detail was remarkable."</p>
        ...
        <div className="testimonial__card">
          <p className="p__opensans">"Our wedding catering was flawless. Guests are still talking about the food weeks later!"</p>
          <div className="testimonial__author">
